...
public class SubAdminHistoryShowActivity extends AppCompatActivity
{

    private android.support.v7.widget.Toolbar mToolbar;
    private RecyclerView mPeopleRV;
    private DatabaseReference mDatabase;
    private FirebaseRecyclerAdapter<AreaCollection, AreaCollectionActivity.ContactViewHolder> mPeopleRVAdapter;
    Dialog dialog;
    String Area;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sub_admin_history_show);


        mToolbar=findViewById(R.id.sub_collection_toolbar);
        ...
        if (extras != null) {
            ...
            String status = extras.getString("sub_admin_id");
            Area=status;
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("sub_paid_month").child(Area);
        mDatabase.keepSynced(true);

        mPeopleRV =  findViewById(R.id.sub_collection_myRecycleView);

        DatabaseReference personsRef = FirebaseDatabase.getInstance().getReference().child("sub_paid_month").child(Area);
